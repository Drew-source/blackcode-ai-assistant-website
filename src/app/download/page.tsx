        ...
        <div className="container-custom">
          <div className="max-w-4xl mx-auto bg-white rounded-lg shadow-lg overflow-hidden">
            <div className="p-8 border-b">
              ...
              <p className="text-center text-gray-600 mb-6">Version 1.0.3 | Released March 18, 2025</p>
              ...
              <ol className="space-y-4 mb-8">
                ...
                <li className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 text-sm">Open the downloaded file and follow the installation wizard.</p>
                  </div>
                </li>
                ...
                <li className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 text-sm">Use your Blackcode Research account or create a new one.</p>
                  </div>
                </li>
                ...
                <li className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 text-sm">Add your API keys for Claude, OpenAI, and other services.</p>
                  </div>
                </li>
              </ol>
            ...
            <div>
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <p className="text-gray-600">Windows 10 (64-bit) or Windows 11</p>
                </div>
                
                <div>
                  <h3 className="font-bold mb-2">Processor</h3>
                  <p className="text-gray-600">Intel Core i5 or equivalent (2.0 GHz or higher)</p>
                </div>
                
                <div>
                  <h3 className="font-bold mb-2">Memory</h3>
                  <p className="text-gray-600">8GB RAM minimum, 16GB recommended</p>
                </div>
                
                <div>
                  <h3 className="font-bold mb-2">Storage</h3>
                  <p className="text-gray-600">2GB free disk space</p>
                </div>
                
                <div>
                  <h3 className="font-bold mb-2">Internet Connection</h3>
                  <p className="text-gray-600">Broadband internet connection required</p>
                </div>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="space-y-4">
                <a href="/docs" className="block p-4 border border-gray-200 rounded-lg hover:bg-neutral-light transition duration-200">
                  ...
                  <p className="text-gray-600 text-sm">Comprehensive guides, tutorials, and reference materials</p>
                </a>
                ...
                <a href="/faq" className="block p-4 border border-gray-200 rounded-lg hover:bg-neutral-light transition duration-200">
                  ...
                  <p className="text-gray-600 text-sm">Answers to common questions and issues</p>
                </a>
                ...
                <a href="/support" className="block p-4 border border-gray-200 rounded-lg hover:bg-neutral-light transition duration-200">
                  ...
                  <p className="text-gray-600 text-sm">Contact our support team for personalized help</p>
                </a>
              </div>
            </div>
          </div>
