  ...
  return (
    <main>
            ...
            {plans.map((plan, index) => (
              ...
              >
                <div className={`p-6 ${plan.highlight ? 'bg-secondary-orange text-white' : 'bg-white'}`}>
                  <h2 className="text-2xl font-bold mb-2" style={{color: plan.highlight ? 'white' : 'black'}}>{plan.name}</h2>
                  <div className="flex items-end">
                    <span className="text-4xl font-bold" style={{color: plan.highlight ? 'white' : 'black'}}>{plan.price}</span>
                    <span className="text-sm ml-2 mb-1" style={{color: plan.highlight ? 'white' : 'black'}}>/ {plan.period}</span>
                  </div>
                  <p className="mt-3" style={{color: plan.highlight ? 'white' : 'black'}}>
                    {plan.description}
                  </p>
                </div>
                  ...
                  <ul className="space-y-4">
                    {plan.features.map((feature, featureIndex) => (
                      <li key={featureIndex} className="flex items-center">
                        ...
                        <span style={{color: feature.included ? 'black' : '#777777', fontWeight: feature.included ? '500' : '400'}}>
                          {feature.name}
                        </span>
                      </li>
                    ))}
      ...
      <section className="py-16 bg-neutral-light">
        <div className="container-custom">
          <h2 className="text-3xl font-bold mb-12 text-center" style={{color: 'black'}}>Frequently Asked Questions</h2>
