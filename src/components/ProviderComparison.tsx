    ...
    <div className="py-12 bg-white">
      <div className="container-custom">
        <div className="text-center mb-12">
          <h2 className="text-3xl font-bold mb-4">Multi-Provider AI Integration</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {providers.map((provider, index) => (
            <motion.div 
              ...
              className={`bg-white p-6 rounded-lg shadow-md border-t-4 ${provider.color}`}
            >
              <div className="flex items-center justify-center mb-6">
                <div className="w-16 h-16 bg-neutral-light rounded-full flex items-center justify-center">
                  {/* This would be replaced with actual logos */}
                  <span className="font-bold">{provider.name.split(' ')[0]}</span>
                </div>
              </div>
              
              <h3 className="text-xl font-bold mb-3 text-center">{provider.name}</h3>
              
              <h4 className="font-semibold text-gray-700 mb-2">Core Strengths:</h4>
        ...
        <div className="mt-16 bg-neutral-light p-8 rounded-lg shadow-md">
          <h3 className="text-2xl font-bold mb-6 text-center">Integration Architecture</h3>
          
          <div className="relative py-6">
            {/* Integration flow diagram */}
            <div className="flex flex-col md:flex-row justify-between items-center max-w-4xl mx-auto">
              <div className="flex flex-col items-center mb-8 md:mb-0">
                <div className="bg-white rounded-lg p-4 shadow-md mb-2 w-44">
                  <h4 className="font-bold text-center mb-1">User Request</h4>
                  <p className="text-sm text-gray-600 text-center">Voice or text input</p>
                </div>
                <div className="h-8 w-0.5 bg-gray-300 md:hidden"></div>
              </div>
              ...
              <div className="flex flex-col items-center mb-8 md:mb-0">
                <div className="bg-primary-blue text-white rounded-lg p-4 shadow-md mb-2 w-44">
                  ...
                  <p className="text-sm text-gray-200 text-center">Directs to optimal model</p>
                </div>
                <div className="h-8 w-0.5 bg-gray-300 md:hidden"></div>
              </div>
          ...
          <div className="mt-8">
            <h4 className="font-bold mb-3">Benefits of Multi-Provider Approach:</h4>
            <ul className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <li className="bg-white p-3 rounded shadow-sm flex items-start">
                ...
                <span>Leverages each provider's unique strengths</span>
              </li>
              <li className="bg-white p-3 rounded shadow-sm flex items-start">
                <span className="text-secondary-orange mr-2 font-bold">•</span>
                <span>Provides fallback mechanisms for reliability</span>
              </li>
              <li className="bg-white p-3 rounded shadow-sm flex items-start">
                <span className="text-secondary-orange mr-2 font-bold">•</span>
                <span>Ensures optimal performance for each task type</span>
              </li>
              <li className="bg-white p-3 rounded shadow-sm flex items-start">
                <span className="text-secondary-orange mr-2 font-bold">•</span>
                <span>Maintains context across different providers</span>
              </li>
            </ul>
          </div>
        </div>
